...
public class RangoDbContext(DbContextOptions<RangoDbContext> options) : IdentityDbContext(options) { //novo modelo de declarar 
    ...
    /*
        Esse método é chamado quando o Entity Framework está construindo o modelo do banco de dados — ou seja,
        ele define como as entidades (classes) vão ser mapeadas para tabelas no banco.    
     */
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        _ = modelBuilder //cria tabela de relacionamento automatico
            .Entity<Rango>()
